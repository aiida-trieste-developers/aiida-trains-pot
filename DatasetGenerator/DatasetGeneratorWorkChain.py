...
from dataset_generator_functions import RattleGenerator, WriteDataset

PwBaseWorkChain = WorkflowFactory('quantumespresso.pw.base')
TrajectoryData = DataFactory('core.array.trajectory')
# StructureDataList = DataFactory('datasetgenerator.structuredatalist')

# class StructureDataList(Data):
...
#         # self.put_object_from_file(structure_list, 'structure_list') # Store the file in the repository under the given filename
#         self.base.attributes.set('structure_list', structure_list)  # Store in the attributes what the filename is
...
#         """
#         structure_list = self.base.attributes.get('structure_list')
#         return self.get_object_content(structure_list)
