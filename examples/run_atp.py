from aiida.orm import load_code, load_node, load_group, Str, Dict, Int, Bool, Float, StructureData, PortableCode
...
input_structures = [StructureData(ase=read('/home/bidoggia/onedrive/aiida/git/NNIPDevelopment/examples/gr8x8.xyz'))]
...
MACE_config = '/home/bidoggia/onedrive/aiida/git/organisation/aiida-trains-pot/examples/mace_config.yml'
